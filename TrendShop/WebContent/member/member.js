function go_save() {
  if (document.formm.id.value == "") {
    ...
    document.formm.action = "TrendshopServlet?command=join";
...
function idcheck() {
  ...
  var url = "TrendshopServlet?command=id_check_form&id=" 
...
function post_zip() {
  var url = "TrendshopServlet?command=find_zip_num";
  window.open( url, "_blank_1",
...
function go_next() {
  if (document.formm.okon1[0].checked == true) {
    document.formm.action = "TrendshopServlet?command=join_form";
    document.formm.submit();
